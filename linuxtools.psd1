...
@{
	...
	Copyright         = '(c) 2023-2026 Skatterus von Bolregard de Maximus. All rights reserved.'
	Description       = 'An experimental PowerShell module for Linux nerds. A bit Debian/Cinnamon focused, but no reason to limit this. Because: everyone said it was a dumb idea. And the universe thrives on dumb ideas.'
